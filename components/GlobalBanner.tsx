...
export default function GlobalBanner({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex justify-center min-h-[40vh] md:min-h-[55vh] lg:min-h-[70vh] xl:min-h-[85vh] w-full container items-center px-4 sm:px-6 md:px-10 lg:px-14 py-30 md:py-20">
        {children}
      </div>
