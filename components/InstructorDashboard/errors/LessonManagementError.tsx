...
export default function LessonManagementError({ refetch }: { refetch: () => void }) {
  return (
        ...
        <CardContent className="flex flex-col items-center justify-center py-12">
          <div className="flex flex-col items-center text-center max-w-md">
            ...
            <p className="text-muted-foreground mb-6">
              There was an error loading the lesson data. This could be due to a network issue or the module might not exist.
            </p>
